$(document).ready(function () {
    ...
    const route = {
        ...
        handler: function () {
            // Handler code here
            $('#nav-commander').removeClass()
            $('#nav-commander').addClass('rounded-lg px-3 py-2 border border-white border-transparent hover:bg-primary hover:scale-105 transition active:bg-primary-100')
        },
    }
